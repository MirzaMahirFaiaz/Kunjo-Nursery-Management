...
create or replace package body insert_product_package as
    ...
    IS
    BEGIN
        insert into Product1@site1(product_name,product_description,product_origin,product_type,
    ...
    IS
    BEGIN
        insert into Product2(product_name,product_description,product_origin,product_type,
        product_purchase_rate,product_sales_rate,total_quantity,BranchID) values 
        (p_name,p_desc,p_model,p_brand,p_purchase,p_sales,p_quantity,branch_id);
		commit;
...
ACCEPT ProductOriginInput PROMPT "Enter product origin:";
ACCEPT ProductTypeInput PROMPT "Enter product type:";
